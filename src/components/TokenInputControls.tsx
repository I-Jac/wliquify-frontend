...
export const TokenInputControls: React.FC<TokenInputControlsProps> = ({
    ...
    const inputPlaceholder = t('tokenTable.amount', { symbol: isDeposit ? symbol : 'wLQI' });
        ...
        <div className="flex flex-col space-y-1">
            <div className="flex items-center justify-between">
                <div className="text-gray-400 text-[10px] flex items-center">
                    ...
                    <span>{t('balance', { value: displayUserBalance, symbol: isDeposit ? symbol : 'wLQI' })}</span>
                </div>
            ...
            <div className="relative w-full">
                ...
                {showTargetButton && handleSetTargetAmount && (
                    <button
                        ...
                        title={t('tokenTable.toTarget')}
                    >
                        {t('tokenTable.toTarget')}
                    </button>
                )}
            </div>
